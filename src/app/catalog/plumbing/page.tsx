...
import { plumbingDescription, plumbingFon, plumbingProjects, plumbingSubTitle, plumbingTitle, plumbingTitle2 } from '@/image/photo/Catalog/plumbing/plumbing'
...
const CatalogPage = () => {
    ...
    return (
        <>
            ...
            <About fon={plumbingFon} title={plumbingTitle} subtitle={plumbingSubTitle} setMenuCount={setMenuCount}/>
            <Description currentPage={plumbingTitle} title={plumbingTitle2} description={plumbingDescription} />
            <Project projects={plumbingProjects} />
